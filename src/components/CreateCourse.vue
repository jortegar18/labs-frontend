      ...
      <div class="mt-5">
        <form class="border border-primary rounded form-inline" @submit="associate">
          ...
          <div class="form-group col-12">
            ...
            <input id="horas" class="form-control col-12 col-sm-10 col-md-7 offset-sm-1" type="text" placeholder="Horas" v-model="courseDurationHours" required/>
...
export default {
  ...
  methods: {
    crearCurso() {
      ...
      axios.post('http://localhost:9090/profesor/crear-curso', nuevoCurso) // Cambiar la URL según la configuración de tu backend de Spring
        .then(response => {
